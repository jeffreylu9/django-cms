...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'cms_page_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('page', models.ForeignKey(orm['cms.page'], null=False)),
            ('tag', models.ForeignKey(orm[u'galleries.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['page_id', 'tag_id'])


        # Changing field 'Page.score'
        db.alter_column(u'cms_page', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Page.numWhoRated'
        db.alter_column(u'cms_page', 'numWhoRated', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Removing M2M table for field tags on 'Page'
        db.delete_table(db.shorten_name(u'cms_page_tags'))


        # Changing field 'Page.score'
        db.alter_column(u'cms_page', 'score', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Page.numWhoRated'
        db.alter_column(u'cms_page', 'numWhoRated', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'cms.page': {
            ...
            'galleries': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'gallery_resources'", 'blank': 'True', 'to': u"orm['galleries.Gallery']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'numWhoRated': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'tag_resource'", 'blank': 'True', 'to': u"orm['galleries.Tag']"}),
        ...
        u'galleries.gallery': {
            ...
            'approved': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'galleries_approved'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            'default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'gtype': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

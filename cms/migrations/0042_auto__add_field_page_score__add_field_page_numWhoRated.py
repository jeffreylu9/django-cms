...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.score'
        db.add_column(u'cms_page', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Page.numWhoRated'
        db.add_column(u'cms_page', 'numWhoRated',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.score'
        db.delete_column(u'cms_page', 'score')

        # Deleting field 'Page.numWhoRated'
        db.delete_column(u'cms_page', 'numWhoRated')
    ...
    models = {
        ...
        'cms.page': {
            ...
            'numWhoRated': ('django.db.models.fields.IntegerField', [], {'default': '0'}),

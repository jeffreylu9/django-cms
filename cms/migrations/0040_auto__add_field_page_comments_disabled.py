...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.comments_disabled'
        db.add_column(u'cms_page', 'comments_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.comments_disabled'
        db.delete_column(u'cms_page', 'comments_disabled')

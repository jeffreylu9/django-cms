...
URL_CMS_PLUGIN_ADD = "cms/cmsadmin/cms/page/add-plugin/" #urljoin(URL_CMS_PAGE_CHANGE, "add-plugin/")
URL_CMS_PLUGIN_EDIT = "cms/cmsadmin/cms/page/edit-plugin/" #urljoin(URL_CMS_PAGE_CHANGE, "edit-plugin/")
URL_CMS_PLUGIN_MOVE = "cms/cmsadmin/cms/page/move-plugin/" #urljoin(URL_CMS_PAGE_CHANGE, "move-plugin/")
URL_CMS_PLUGIN_REMOVE = "cms/cmsadmin/cms/page/remove-plugin/" #urljoin(URL_CMS_PAGE_CHANGE, "remove-plugin/")

    ...
    *instances* in the Admin.
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        try:
            ...
            self.queryset = self.get_queryset(request).filter(created_by=user.username)
        except:
            raise
    ...
    def set_items(self, request):
        ...
        # Used to order by tree
        # pages = self.get_queryset(request).drafts().order_by('tree_id',  'lft').select_related()
